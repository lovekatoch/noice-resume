...
import { captureRoastGenerated, captureRoastShared } from "lib/analytics";
      ...
      >
        {loading ? (
          <div className="flex flex-col items-center justify-center py-16 gap-4">
            <svg className="h-8 w-8 animate-spin" fill="none" viewBox="0 0 24 24" style={{ color: ACCENT }}>
          ...
          <div className="flex flex-col items-center py-12 px-6 gap-4">
            <div className="rounded-full p-3" style={{ backgroundColor: "rgba(220,38,38,0.1)" }}>
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#DC2626" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
            </div>
            <p className="text-sm text-center" style={{ color: INK_MUTED }}>{error}</p>
            <button
              onClick={onClose}
          ...
          <>
            ...
            <div className="pt-8 pb-4 px-6 flex flex-col items-center gap-3">
              ...
              <p className="text-lg font-semibold text-center leading-snug" style={{ color: INK }}>
                {roastData.summary}
              </p>
            </div>
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span
                      ...
                      style={{
                        color: cat.score >= 8 ? "#27A644" : cat.score >= 5 ? "#E8A317" : "#DC2626",
                      }}
                    >
                      {cat.score}/10
                    </span>
                  </div>
                  <p className="text-[11px] leading-tight" style={{ color: INK_MUTED }}>
                    {cat.tip}
                  </p>
                </div>
              ))}
            ...
            {roastData.oneTip && (
              <div className="px-6 pb-4">
                ...
                >
                  <svg className="h-4 w-4 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke={ACCENT} strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                  <p className="text-xs leading-relaxed" style={{ color: INK_MUTED }}>
                    <span style={{ color: ACCENT }} className="font-semibold">Tip: </span>
                    {roastData.oneTip}
                  </p>
                </div>
              </div>
            ...
            <div className="px-6 pb-6 flex flex-col gap-2">
              ...
              >
                {copied ? (
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#27A644" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
