...
export function PostDownloadShare({
  ...
  const sharedBtnClasses = "share-btn flex items-center gap-3 px-4 py-2.5 rounded-full text-sm font-medium w-full";
      ...
      >
        <div className="flex items-start gap-3 mb-5">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm" style={{ color: "var(--fg)", fontFamily: "var(--font-display)" }}>
              Your resume is ready
            </h3>
            <p className="text-xs mt-0.5" style={{ color: "var(--body)" }}>
              Download your resume and share it with your network
            </p>
          </div>
          <button
            ref={closeRef}
        ...
        {onDownload && (
          <button
            onClick={onDownload}
            className="flex w-full items-center justify-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold text-white transition-all hover:opacity-90 active:scale-[0.98] mb-5"
        ...
        <div className="flex flex-col gap-2">
          <p className="text-xs font-semibold uppercase tracking-wider mb-1" style={{ color: "var(--muted)", letterSpacing: "0.06em" }}>
            Share
          </p>
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center">
            <span className="px-2 text-[10px] uppercase tracking-wider" style={{ color: "var(--muted)", backgroundColor: "var(--surface)", letterSpacing: "0.06em" }}>
              Share
            </span>
          </div>
        </div>
        ...
        <button
          ...
          className="share-btn flex items-center gap-3 px-4 py-2.5 rounded-full text-sm font-medium w-full"
          style={{
        ...
        >
          ...
          {referralCopied ? "Referral link copied" : "Invite a friend"}
        </button>
